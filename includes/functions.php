		...
		$html = '<div id="virp-random-posts" class="virp-random-' . sanitize_html_class( $args['post_type'] ) .'">';
			...
			$html .= '<ul class="virp-ul">';
				...
				while ( $posts->have_posts() ) : $posts->the_post();
					$id = get_the_id();
					$html .= '<li class="virp-li virp-clearfix">';
							...
							if ( has_post_thumbnail() ) :
								...
								$html .= '<a href="' . esc_url( get_permalink() ) . '"  rel="bookmark">';
									if ( $args['thumbnail_custom'] ) :
										$html .= '<img class="virp-thumbnail align' . esc_attr( $args['thumbnail_align'] ) . '" src="' . esc_url( $image ) . '" alt="' . esc_attr( get_the_title() ) . '">';
									else :
										$html .= get_the_post_thumbnail( get_the_ID(), $args['thumbnail_size'], array( 'alt' => esc_attr( get_the_title() ), 'class' => 'virp-thumbnail align' . esc_attr( $args['thumbnail_align'] ) ) );
									endif;
								$html .= '</a>';
